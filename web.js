    ...
    fetch('./JSON-Files/accessories.json')
...
function appendData(data) {
    var mainContainer = document.getElementById("accesories-json");
...
// http.open('get', './JSON-Files/accessories.json', true);     //Prepared request with open() method 
// http.send();
